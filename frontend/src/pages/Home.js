    ...
    <>
      <div className="homeContainer">
        ...
        <div className="homeDesc">
          EnQueueBazaar provides a dedicated platform for clients to easily find and
        ...
        <div className="chooseCont">
          ...
          <div>
            <div className="chooseTitle">
              Why Choose <span>EnQueueBazaar?</span>
            </div>
        ...
        <div className="clientCont">
          <div>
            ...
            <div className="clientDesc">
              EnQueueBazaar is the ultimate freelance platform for coders and
              developers to find gigs and showcase their skills. Join EnQueueBazaar
